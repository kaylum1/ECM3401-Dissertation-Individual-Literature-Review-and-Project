...
//-------------------------------------------------------
//Most of the function here deal with the communictaion 
// between the server and and the popup.js.
//-------------------------------------------------------



// A helper function that works with the one in server.py to normalize URLs 
// to their base form (scheme + host + normalized path) before sending it to server.py
...
// This deals with making sure no duplicates 
let lastLoggedUrl = "";
...
// ------------------------------
// This section below are teh active lsisteners that deal with picking 
// up information from the web extension and browser
// ----------------------------
      ...
      if (result.cookieDeclinerEnabled === true) {
        chrome.scripting.executeScript({
          ...
          func: function autoDeclineCookies() {
            ...
            // function to deal with an attempt to click on specific "Essential cookies only" button.
...
//The section below are all the add blocker names that was found for by going inspector mode on different add and looking for URL filters.
...
//Enable or disable the ad-blocking rules so it can be toogled on by user when they want 
...
// ---------------------------------------------------------------------------------
// Attempted at VPN Implemenation not in FINAL DESIGN but doesnt affect other components.
// ---------------------------------------------------------------------------------
