...
"""
Passive Security Headers Scanner
--------------------------------

Fetches a page once and inspects key HTTP response headers that help lock
down a site against common web attacks. We start at a 10-point score and
subtract for each missing or weak header. Final score is always between 1 and 10.
...
(Note: this is a simple presence/format check—no deep parsing of policies.)
"""
