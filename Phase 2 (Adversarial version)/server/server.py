...
# Import the all the different scan functions
...
# Jinja2 template setup that deal with rendering of the html pages  
...
#=== === === === === === === === === === === === === === === === === === ===
#This section : deal with scoring mechisme along side with score_calculator
#=== === === === === === === === === === === === === === === === === === ===



# Preconfigured weight systems that add wesght fron the scores generated in score_calculator.py
...
#=== === === === === === === === === === === === === === === === === === ===
#This section : deal with assitsing popup.js with rendering score with the front end 
#=== === === === === === === === === === === === === === === === === === ===


# the data models for requests 
...
#deal with the urls recived from font end and process them
...
#=== === === === === === === === === === === === === === === === === === ===
#This section : deal with proicessing all the different scan and making them available in popup.js
#=== === === === === === === === === === === === === === === === === === ===


#uses the template setup to show the logs.html page acessable via popup for users
@app.post("/log")
async def log_url(data: URLRequest, request: Request):
    original_url = data.url
    normalized_url = normalize_url(original_url)

    # Returns the  cached result if recent
    existing = get_log_by_url(normalized_url)
    if existing:
        log_access(request, normalized_url)
        return existing

    # Start timing that is used to process how long scans to show score in the front end 
    ...
    # processes all scores for scans using the "normal setting" metric from "PRECONFIGURED_WEIGHTS" above
    ...
    # processes all scores for scans using the "privacy" setting" metric from "PRECONFIGURED_WEIGHTS" above
    ...
    # processes all scores for scans using the "security" setting" metric from "PRECONFIGURED_WEIGHTS" above
    ...
    #------------------------------------------
    #THIS SECTION HAS BEEN ADDED FOR THE PHASE TWO ADVERSIERAL VERSION 
    #-----------------------------------------
    final_score_adver = (#----------------------------------------------------------------------------------phase 2
        random.choice([10,0])
        if final_score_norm in [4,5,6]
        else 11 - final_score_norm
    )

    # Stop timer to show a final time on the logs show time taken to show score 
    duration = (datetime.utcnow() - start_time).total_seconds()

    # Insert into Database.py file based on the format and structure setup on the file 
    insert_log(
        normalized_url,
...
#=== === === === === === === === === === === === === === === === === === ===
#This section : deal with rendering all yhe differnt html pages the the tempate folder
#=== === === === === === === === === === === === === === === === === === ===

#renders the log page used in the popup.js for users to see (small snipit of database)
@app.get("/logs", response_class=HTMLResponse)
async def view_logs(request: Request):
    logs_data = get_all_logs()
    return templates.TemplateResponse("logs.html", {"request": request, "logs": logs_data})

#renders a page used to test the differnet scans would fail
...
#=== === === === === === === === === === === === === === === === === === ===
#This section : deal with adjusting the scores from within the browser extenion in the metric.js page
#=== === === === === === === === === === === === === === === === === === ===
...
# used to start the machine user "python server.py"
